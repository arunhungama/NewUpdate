...
class Utils {
    companion object {
            ...
            try {
                val signatures = with(context.packageManager){
                    if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.P) {
                        getPackageInfo(BuildConfig.APPLICATION_ID, PackageManager.GET_SIGNING_CERTIFICATES)
                            .signingInfo
                            ?.apkContentsSigners
                    } else {
        ...
        fun showSnakbar(context: Context,view: View, isError: Boolean, message: String,page_name:String="",api_name:String="",error_code:String="",responce_code:String="",url:String="",responce_time:String="") {

            val messageModel = MessageModel(message, MessageType.NEGATIVE, true)
        ...
        fun getContentTypeNameForStream(contentTypeId: String): String {
            if (contentTypeId.equals("20", true)) {
                return "live_concert"
            } else if (contentTypeId.equals("21", true) || contentTypeId.equals("0", true)) {
                return "song"
            } else if (contentTypeId.equals("22", true) || contentTypeId.equals(
                    "51",
                    true
                ...
                return "mood_radio"
            }else if (contentTypeId.equals("114", true)) {
                return "audio_book"
            }else if (contentTypeId.equals("117", true)) {
                return "audio_story"
            } else {
                return getContentTypeDetailName(contentTypeId)
            }
        ...
        fun shareItem(context: Context, mURL: String) {
            BaseActivity.isShareClicked = true
        ...
        fun registerUserMethod_AF(
            ...
            CoroutineScope(Dispatchers.IO).launch {
                ...
                if (isRegisterEventAdded) {
                    ...
                    eventValue.put(AFInAppEventParameterName.REGISTRATION_METHOD, methodName)
