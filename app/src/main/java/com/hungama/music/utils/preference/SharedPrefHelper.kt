...
class SharedPrefHelper {
    ...
    fun disconnectFromFacebook() {
        ...
        GraphRequest(AccessToken.getCurrentAccessToken(), "/me/permissions/", null,
            HttpMethod.DELETE, object : DaemonRequest.Callback, GraphRequest.Callback {
...
//            LoginManager.getInstance().logOut()
    ...
    fun setVideoAutoPlay(isAutoPlay: Boolean) {
        sharedPreferences?.edit()?.putBoolean(PrefConstant.VIDEO_AUTO_PLAY, isAutoPlay)?.apply()
    }

    fun getVideoAutoPlay():Boolean {
        return sharedPreferences?.getBoolean(PrefConstant.VIDEO_AUTO_PLAY, false) == true
    }
