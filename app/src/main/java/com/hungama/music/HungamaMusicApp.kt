...
import com.hungama.music.eventanalytic.eventsubscriber.MoengageSubscriber
 ...
 */
class HungamaMusicApp : MultiDexApplication() {
...
//        ChangeAppIconWorker.enqueue(this)
        ...
        try {
            ...
            val config = ClarityConfig(Constant.CLARITY_PROJECT_ID)
