...
import com.hungama.music.utils.Constant.screen_name
    ...
    private inner class StartDownloadDialogHelper(
        ...
        override fun onPrepared(helper: DownloadHelper) {
            ...
            if (Util.SDK_INT < 18) {
                ...
                showToast(context, messageModel,"DownloadTracker","onPrepared")
                setLog(
                    TAG,
            ...
            if (!hasSchemaData(format.drmInitData)) {
                ...
                showToast(context, messageModel,"DownloadTracker","!hasSchemaData(format.drmInitData)")
                setLog(
                    TAG,
        ...
        override fun onPrepareError(helper: DownloadHelper, e: IOException) {
            ...
            showToast(context, messageModel,"DownloadTracker","onPrepareError")
        ...
        fun onOfflineLicenseFetchedError(e: DrmSession.DrmSessionException) {
            ...
            showToast(context, messageModel,"DownloadTracker","onOfflineLicenseFetchedError")
