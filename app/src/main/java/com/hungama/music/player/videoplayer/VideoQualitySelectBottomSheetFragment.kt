        ...
        rvQuality.apply {
            ...
            videoQualityMap.keys.forEach {
                ...
                if (it.equals(getString(R.string.quality_1))){
                    videoQuality.id = 1
                }else if (it.equals(getString(R.string.quality_2))){
                    videoQuality.id = 2
                }else if (it.equals(getString(R.string.video_player_str_27))){
                    videoQuality.id = 3
                }else if (it.equals(getString(R.string.movie_str_10))){
                    videoQuality.id = 4
                }
                else if (it.equals(getString(R.string.quality_5))){
                    videoQuality.id = 5
                }
...
/*                if (!TextUtils.isEmpty(SharedPrefHelper.getInstance().get(PrefConstant.LAST_VIDEO_QUALITY, ""))
                    && it.contains(SharedPrefHelper.getInstance().get(PrefConstant.LAST_VIDEO_QUALITY, ""))) {
                ...
                val videoId = SharedPrefHelper.getInstance().getVideoPlaybackStreamQualityId()
                setLog("aghasfh", "$videoId")
