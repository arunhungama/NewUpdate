...
@Database(version = 26,exportSchema=true,entities = arrayOf(Track::class, BodyRowsItemsItem::class, DownloadQueue::class, DownloadedAudio::class, SongDurationModel::class))
@TypeConverters(
...
abstract class AppDatabase : RoomDatabase() {
    ...
    companion object {
        ...
        val MIGRATION_25_26 = object : Migration(25, 26) {
            override fun migrate(database: SupportSQLiteDatabase) {
                database.execSQL("ALTER TABLE BodyRowsItemsItem ADD COLUMN 'modified' TEXT DEFAULT 0")
                database.execSQL("ALTER TABLE BodyRowsItemsItem ADD COLUMN 'remark' TEXT DEFAULT ''")
            }
        }
