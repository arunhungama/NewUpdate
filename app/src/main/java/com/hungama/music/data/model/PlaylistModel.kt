...
data class PlaylistModel(
    ...
    data class Data(
            ...
            data class Row(
                ...
                data class Info(
                    ...
                    data class CastData(
                        ...
                        @SerializedName("variant_details") var variantDetails: String? = null,
                        @SerializedName("genre") var genre: ArrayList<String> = arrayListOf(),
                        @SerializedName("genre_en") var genreEn: ArrayList<String> = arrayListOf(),
                        @SerializedName("category") var category: ArrayList<String> = arrayListOf(),
                        @SerializedName("subgenre_name") var subgenreName: ArrayList<String> = arrayListOf(),
        ...
        data class Head(
            ...
            @SerializedName("image")
            var image: String = "",
            @SerializedName("tv_show_image")
            var tv_show_image: String = "",
            @SerializedName("share")
            var share: String = "",
            @SerializedName("lang")
            var lang: List<String> = listOf(),
