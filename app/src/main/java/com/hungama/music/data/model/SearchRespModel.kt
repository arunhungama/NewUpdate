...
data class SearchRespModel(
    ...
    data class Data(
        ...
        data class Body(
            ...
            @SerializedName("audio_book_episode")
            var audio_book_episode: List<BodyRowsItemsItem> = listOf(),
            @SerializedName("audio_stories_episode")
            var audio_stories_episode: List<BodyRowsItemsItem> = listOf(),
            @SerializedName("song")
