...
class ArtistRepos {
    ...
    private var paytmInsiderDetailModel = MutableLiveData<Resource<PaytmInsiderDetailModel>>()
    ...
    fun getPaytmInsiderDetail(context: Context,id: String): MutableLiveData<Resource<PaytmInsiderDetailModel>> {
        CoroutineScope(Dispatchers.IO).launch{
            val url= WSConstants.METHOD_LIVE_DETAIL_CONTENT + id + "/offlineevent/detail"
//            val url= "https://stagpage.api.hungama.com/v2/page/content/" + id + "/offlineevent/detail"
            ...
            DataManager.getInstance(context)?.getVolleyRequest(context,url, JSONObject(),object : DataValues {
                override fun setJsonDataResponse(response: JSONObject?) {
                    ...
                    try {
                        val paytmInsiderDetailModelData = Gson().fromJson<PaytmInsiderDetailModel>(
                            response.toString(),
                            PaytmInsiderDetailModel::class.java
                        ) as PaytmInsiderDetailModel

                        paytmInsiderDetailModel.postValue(Resource.success(paytmInsiderDetailModelData))
                        ...
                        exp.printStackTrace()
                        paytmInsiderDetailModel.postValue(Resource.error(context.getString(R.string.discover_str_2), null))
                    }
                }
        ...
        return paytmInsiderDetailModel
    }
