...
data class AdsConfigModel(
    ...
    @SerializedName("mi_deeplink_sessions")
    var miDeeplinkSessions: MiDeeplinkSessions = MiDeeplinkSessions(),

    @SerializedName("hero_section_control")
    var hero_section_control: HeroSectionControl = HeroSectionControl(),

    @SerializedName("nudge_music_video_banner")
    var nudge_music_video_banner: DrawerDownloadAll = DrawerDownloadAll(),

    @SerializedName("drawer_streaming_podcast")
    var drawer_streaming_podcast: DrawerDownloadAll = DrawerDownloadAll(),

    @SerializedName("drawer_genric1_subscription")
    var drawer_genric1_subscription: DrawerDownloadAll = DrawerDownloadAll(),

    @SerializedName("drawer_streaming_mymix")
    var drawer_streaming_mymix: DrawerDownloadAll = DrawerDownloadAll(),

    @SerializedName("drawer_streaming_sleeptimer")
    var drawer_streaming_sleeptimer: DrawerDownloadAll = DrawerDownloadAll(),

    @SerializedName("drawer_streaming_audiobook")
    var drawerStreamingAudiobook: DrawerDownloadAll = DrawerDownloadAll(),

    @SerializedName("drawer_streaming_audiostory")
    var drawerStreamingAudiostory: DrawerDownloadAll = DrawerDownloadAll(),

    @SerializedName("video_prompt")
    var video_prompt: Video_prompt = Video_prompt(),
    @SerializedName("ribbon_pdc_gold")
    var ribbon_pdc_gold: Boolean = false,

    @SerializedName("ribbon_pdc_free")
    var ribbon_pdc_free: Boolean = false,

    @SerializedName("ribbon_pdc_limited")
    var ribbon_pdc_limited: Boolean = false,

    @SerializedName("ribbon_audio_book_free")
    var ribbon_audio_book_free: Boolean = false,

    @SerializedName("ribbon_audio_book_gold")
    var ribbon_audio_book_gold: Boolean = false,

    @SerializedName("ribbon_audio_book_limited")
    var ribbon_audio_book_limited: Boolean = false,

    @SerializedName("ribbon_audio_stories_free")
    var ribbon_audio_stories_free: Boolean = false,

    @SerializedName("ribbon_audio_stories_gold")
    var ribbon_audio_stories_gold: Boolean = false,

    @SerializedName("ribbon_audio_stories_limited")
    var ribbon_audio_stories_limited: Boolean = false,
    ...
    @Keep
    @Parcelize
    data class MiDeeplinkSessions(
        @SerializedName("deep_link_url")
        var deep_link_url: String = "",
        @SerializedName("till_session")
        var till_session: Int = 0
    ) : Parcelable
    ...
    data class DrawerDownloadAll(
        @SerializedName("enable_drawer")
        var enable_drawer: String = "",
