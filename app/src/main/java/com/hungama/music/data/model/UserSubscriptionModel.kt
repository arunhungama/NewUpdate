...
data class UserSubscriptionModel(
    ...
    data class Data(
        ...
        data class Subscription(
            ...
            @SerializedName("subscription_start_date_time")
            var subscriptionStartDateTime: String? = "",
            @SerializedName("subscription_end_date_time")
            var subscriptionEndDateTime: String? = "",
