...
class PodcastRepos {
    ...
    fun getPodcastEpisodeList(context: Context, id:String, page:Int): MutableLiveData<Resource<PlaylistDynamicModel>> {
        ...
        CoroutineScope(Dispatchers.IO).launch{
            val url=WSConstants.METHOD_DETAIL_CONTENT_V1+id+"/podcast/episodes/"+ page
    ...
    fun getAdioBookDetailList(context: Context, id: String): MutableLiveData<Resource<PlaylistDynamicModel>> {
        CoroutineScope(Dispatchers.IO).launch{
            val url=WSConstants.METHOD_PLAYABLE_CONTENT_DYNAMIC+id+"/audiobook/detail"
    ...
    fun getAudioBookEpisodeList(context: Context, id:String, page:Int): MutableLiveData<Resource<PlaylistDynamicModel>> {

        CoroutineScope(Dispatchers.IO).launch{
            val url=WSConstants.METHOD_DETAIL_CONTENT_V1+id+"/audiobook/episodes/"+ page
    ...
    fun getAudioStoryEpisodeList(context: Context, id:String, page:Int): MutableLiveData<Resource<PlaylistDynamicModel>> {

        CoroutineScope(Dispatchers.IO).launch{
            val url=WSConstants.METHOD_DETAIL_CONTENT_V1+id+"/audiostory/episodes/"+ page
            var requestTime = DateUtils.getCurrentDateTime()
            dataResp.postValue(Resource.loading(null))
            DataManager.getInstance(context)?.getVolleyRequest(context,url, JSONObject(),object : DataValues {
                override fun setJsonDataResponse(response: JSONObject?) {
