...
import com.hungama.music.data.webservice.WSConstants.METHOD_DETAIL_CONTENT_V2
...
class PlaylistRepos {
    ...
    fun getRecommendedList(
        ...
        CoroutineScope(Dispatchers.IO).launch{
            val url=WSConstants.PAGE+"/content/103694914/similar"
    ...
    fun getSimilarSongList(
        ...
        CoroutineScope(Dispatchers.IO).launch{
            val url= "$METHOD_DETAIL_CONTENT_V2$contentId/similar"
