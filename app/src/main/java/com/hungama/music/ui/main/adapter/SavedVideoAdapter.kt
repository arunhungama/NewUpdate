...
class SavedVideoAdapter(
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        var musicdata = musicplayList?.get(holder.adapterPosition)
        ...
        holder.cvMain.setOnClickListener {
            if (itemClick != null) {
                itemClick.OnTvShowItemClick(holder.adapterPosition)
            }
        }
        holder.rlMoreInfo.setOnClickListener{
            itemClick.OnLibraryItemThreeDotClick(holder.adapterPosition)
        }
    }
