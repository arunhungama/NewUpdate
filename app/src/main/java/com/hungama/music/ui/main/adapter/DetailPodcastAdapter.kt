                ...
                if (currentPlayingContentId?.toString()?.equals(dataItemModel?.id)!!) {
                    ...
                    ivPlay?.setOnClickListener {
                        ...
                        if (!CommonUtils.isUserHasGoldSubscription()){
                           ...
                           if (CommonUtils.checkGoldMusic(dataItemModel.misc.movierights.toString(),dataItemModel.type)){
...
//                }
            ...
            if(dataItemModel.type==109 || dataItemModel.type==110) {
                if (!CommonUtils.isUserHasGoldSubscription())
                    CommonUtils.checkProdcastCheck(
                        ctx,
                        dataItemModel.misc.movierights.toString(),
                        ivfreeStrips
                    )
            }
