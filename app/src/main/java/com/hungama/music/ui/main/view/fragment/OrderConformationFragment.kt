...
class OrderConformationFragment(val productType: Int) : BaseFragment() {
    ...
    override fun initializeComponent(view: View) {
        ...
        copyToClipBoard.setOnClickListener {
            ...
            CommonUtils.showToast(requireContext(), messageModel,"OrderConformationFragment","initializeComponent")
        }
    ...
    private fun setUpPlayableContentListViewModel(id:String) {
        ...
        if (ConnectionUtil(requireContext()).isOnline) {
            ...
            CommonUtils.showToast(requireContext(), messageModel,"OrderConformationFragment","setUpPlayableContentListViewModel")
        }
    }
