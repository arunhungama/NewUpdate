...
//            }
    ...
    private fun getUserSocialData() {
        if (ConnectionUtil(requireContext()).isOnline) {
            ...
            CommonUtils.showToast(requireContext(), messageModel,"UserProfileFollowingFragment","getUserSocialData")
        }
    }
    ...
    private fun setFollowUnFollow(followingId: String, isFollowing:Boolean){
        if (ConnectionUtil(context).isOnline) {
            ...
            val messageModel = MessageModel(getString(R.string.toast_message_5), getString(R.string.toast_message_5),
                MessageType.NEGATIVE, true)
            CommonUtils.showToast(requireContext(), messageModel,"UserProfileFollowingFragment","setFollowUnFollow")
        }
    }
...
//                                }
            ...
            val messageModel = MessageModel(getString(R.string.toast_message_5), getString(R.string.toast_message_5),
                MessageType.NEGATIVE, true)
            CommonUtils.showToast(requireContext(), messageModel,"UserProfileFollowingFragment","syncUserContactList")
        }
    }
        ...
        if (AccessToken.isCurrentAccessTokenActive()){
            ...
            val request = GraphRequest.newGraphPathRequest(
                ...
                try {
                    ...
                    CommonUtils.showToast(requireContext(), messageModel,"UserProfileFollowingFragment","callFacebook")
                }
            ...
            LoginManager.getInstance().registerCallback(callbackManager2, object : FacebookCallback<LoginResult>{
                override fun onCancel() {
                    ...
                    CommonUtils.showToast(requireContext(), messageModel,"UserProfileFollowingFragment","onCancel")
                }

                override fun onError(error: FacebookException) {
                    val messageModel = MessageModel(error.message.toString(), MessageType.NEUTRAL, true)
                    CommonUtils.showToast(requireContext(), messageModel,"UserProfileFollowingFragment","onError")
                }
                ...
                override fun onSuccess(result: LoginResult) {
                    ...
                    val request = GraphRequest.newGraphPathRequest(
                        ...
                        try {
                            ...
                            val messageModel = MessageModel(getString(R.string.discover_str_2), MessageType.NEUTRAL, true)
                            CommonUtils.showToast(requireContext(), messageModel,"UserProfileFollowingFragment","callFacebook-onSuccess")
                        }
    ...
    private fun syncUserFbList(jsonObject: JSONObject) {
        if (ConnectionUtil(requireContext()).isOnline) {
            ...
            val messageModel = MessageModel(getString(R.string.toast_message_5), getString(R.string.toast_message_5),
                MessageType.NEGATIVE, true)
            CommonUtils.showToast(requireContext(), messageModel,"UserProfileFollowingFragment","syncUserFbList")
        }
    }
