...
class RedeemCoinFragment(val smartCollection: ProductCategoryRespModel.SmartCollection?) : BaseFragment(), ProductListAdapter.RedeemInterface,
    ...
    private fun displayUserCoins(){
        setLog("redeemCoin", "displayUserCoins-RedeemCoinFragment-before-userCoins-$userCoins")
        userCoins = GamificationSDK.getPoints()
        setLog("redeemCoin", "displayUserCoins-RedeemCoinFragment-after-userCoins-$userCoins")
...
//            rvCart.visibility = View.VISIBLE
    ...
    private fun getAllProduct(id: Long) {
        ...
        if (ConnectionUtil(requireContext()).isOnline) {
            ...
            CommonUtils.showToast(requireContext(), messageModel,"RedeemCoinFragment","getAllProduct")
        }
    }
