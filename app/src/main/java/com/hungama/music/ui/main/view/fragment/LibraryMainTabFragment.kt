...
class LibraryMainTabFragment : BaseFragment(), TabLayout.OnTabSelectedListener{
    ...
    override fun initializeComponent(view: View) {
        VideoMainTabFragment.retryApi.observe(this, Observer {
            setUpViewModel()
        })
        if (arguments != null){
            ...
            if (arguments?.containsKey("PaytmDetail")!!){
                bottomTabshow = arguments?.getBoolean("PaytmDetail")!!
                if (bottomTabshow)
...
//        tabs.addTab(tabs.newTab().setText(getString(R.string.library_str_4)))
    ...
    private fun viewPagerSetUp() {
        ...
        TabLayoutMediator(childTabs, vpTransactions) { tab, position ->
            ...
            for (i in 0 until childTabs.tabCount) {
                val tab1 = (childTabs.getChildAt(0) as ViewGroup).getChildAt(i)
                val p = tab1.layoutParams as ViewGroup.MarginLayoutParams
    ...
    private fun getChildFragmentList(i: Int): java.util.ArrayList<String> {
        ...
        if (i == 0) {
            ...
            fragmentChildList.add(LibraryPlaylistAllFragment())
            ...
            fragmentChildList.add(AudioBookFragment())
            fragmentChildName.add(getString(R.string.audio_books_str_library_heading))

            fragmentChildList.add(AudioStoryFragment())
            fragmentChildName.add(getString(R.string.search_str_26))
