...
import com.hungama.music.ui.main.view.activity.EnterEmailActivity.Companion
import com.hungama.music.ui.main.view.activity.EnterEmailActivity.Companion.isActiveActivity
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        receiver = object : BroadcastReceiver() {
            override fun onReceive(context: Context?, intent: Intent?) {
                CommonUtils.showActivity(this@MobileOTPVarifyActivity, MobileOTPVarifyActivity::class.java)
            }
        }
        val lbm = LocalBroadcastManager.getInstance(this)
        lbm.registerReceiver(receiver as BroadcastReceiver, IntentFilter(Constant.MOBILE_OTP))
            ...
            try {
                ...
                if (otp != null && !TextUtils.isEmpty(otp)) {
                    ...
                    if (otp.length < 4) {
                        ...
                        CommonUtils.showToast(this, messageModel,"MobileOTPVarifyActivity","onCreate")
            ...
            override fun onVerificationFailed(e: FirebaseException) {
                ...
                try {
                    if (e is FirebaseAuthInvalidCredentialsException) {
                        ...
                        CommonUtils.showToast(this@MobileOTPVarifyActivity, messageModel,"MobileOTPVarifyActivity","onVerificationFailed")
                        ...
                        when(it.status){
                            ...
                            Status.ERROR ->{
                                ...
                                if (it != null) {
                                    ...
                                    CommonUtils.showToast(this, messageModel,"MobileOTPVarifyActivity","callSocialLogin")
...
// Initialize Facebook Login button
        ...
        LoginManager.getInstance().registerCallback(callbackManager, object :
            ...
            override fun onCancel() {
                ...
                CommonUtils.showToast(applicationContext, messageModel,"MobileOTPVarifyActivity","configureFacebook")
            }
...
/*            val appsFlyerUserId = AppsFlyerProperties.getInstance().getString(AppsFlyerProperties.APP_USER_ID)
            ...
            if (action == Constant.SIGNIN_WITH_GOOGLE
                ...
                val url = if (intent.hasExtra(Constant.DeepLink_Payment)) intent.getStringExtra(Constant.DeepLink_Payment).toString() else ""
                  intent = Intent(this@MobileOTPVarifyActivity, MainActivity::class.java)
                if (url.isNotEmpty()) {
...
/*            val credential : PhoneAuthCredential = PhoneAuthProvider.getCredential(
            ...
            e.printStackTrace()
            val messageModel = MessageModel(getString(R.string.discover_str_2), MessageType.NEGATIVE, true)
            CommonUtils.showToast(this, messageModel,"MobileOTPVarifyActivity","validateOtp")
        }
    }
                ...
                if (task.isSuccessful) {
                   ...
                   /* SharedPrefHelper.getInstance().save(PrefConstant.ISLOGIN,true)
                    ...
                    if (task.exception is FirebaseAuthInvalidCredentialsException) {
                        ...
                        CommonUtils.showToast(this, messageModel,"MobileOTPVarifyActivity","signInWithPhoneAuthCredential")
                        try {
...
//                            CommonUtils.showToast(this, messageModel)
            ...
            val messageModel = MessageModel(getString(R.string.toast_str_35), getString(R.string.toast_message_5),MessageType.NEGATIVE, true)
            CommonUtils.showToast(this, messageModel,"MobileOTPVarifyActivity","makeVerifyOtpCall")
        }
    ...
    private fun makeReSendOtpCall(number: String, countryCode: String) {
        ...
        if (ConnectionUtil(this).isOnline) {
            ...
            val messageModel = MessageModel(getString(R.string.toast_str_35), getString(R.string.toast_message_5),MessageType.NEGATIVE, true)
            CommonUtils.showToast(this, messageModel,"MobileOTPVarifyActivity","makeReSendOtpCall")
        }
    ...
    private fun fetchVerificationCode(message: String): String {
        ...
        try {
            ...
            otpCode=Regex("(\\d{4})").find(message)?.value ?: ""
