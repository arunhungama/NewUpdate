...
import com.hungama.music.ui.main.view.activity.MobileOTPVarifyActivity.Companion
...
class EmailOTPVarifyActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        receiver = object : BroadcastReceiver() {
            override fun onReceive(context: Context?, intent: Intent?) {
                CommonUtils.showActivity(this@EmailOTPVarifyActivity, EmailOTPVarifyActivity::class.java)
            }
        }
        val lbm = LocalBroadcastManager.getInstance(this)
        lbm.registerReceiver(receiver as BroadcastReceiver, IntentFilter(Constant.EMAIL_OTP))
        ...
        btnVarify.setOnClickListener {
            ...
            if (otp.isNotEmpty()) {
                ...
                CommonUtils.showToast(this, messageModel,"EmailOTPVarifyActivity","onCreate")
            }
        }
    ...
    private fun callSocialLogin(
        ...
        if (ConnectionUtil(this@EmailOTPVarifyActivity).isOnline) {
            ...
            CommonUtils.showToast(this, messageModel,"EmailOTPVarifyActivity","callSocialLogin")
        }
    }
...
// Initialize Facebook Login button
        ...
        LoginManager.getInstance().registerCallback(callbackManager, object :
            ...
            override fun onCancel() {
                ...
                CommonUtils.showToast(applicationContext, messageModel,"EmailOTPVarifyActivity","configureFacebook")
            }
        ...
        auth.signInWithCredential(credential)
            .addOnCompleteListener(this) { task ->
                ...
                if (task.isSuccessful) {
                    ...
                    CommonUtils.showToast(applicationContext, messageModel,"EmailOTPVarifyActivity","handleFacebookAccessToken")
...
//        setLog("appsFlyerUserId", appsFlyerUserId.toString())
        ...
        else
        {
            ...
            intent = Intent(this@EmailOTPVarifyActivity, MainActivity::class.java)
            if (url!!.isNotEmpty())
    ...
    fun onError(msg:String){
        if (msg != null) {
            ...
            CommonUtils.showToast(this, messageModel,"EmailOTPVarifyActivity","onError")
                ...
                Observer {
                    when(it.status){
                                        ...
                                        when(it.status){
                                            Status.SUCCESS->{
                                                ...
                                                if (it?.data!=null){
                                                    ...
                                                    setLog( "makeVerifyOtpCallEmail"," "+ Gson().toJson(it?.data))
                        ...
                        Status.ERROR ->{
                            ...
                            CommonUtils.showToast(this, messageModel,"EmailOTPVarifyActivity","makeVerifyOtpCall")
                            setProgressBarVisible(false)
                            isOTPVarify=false
                            btnVarify.setBackgroundResource(R.drawable.corner_radius_18_bg_red)
                            progress.visibility = View.GONE
    ...
    private fun makeReSendOtpCall(email: String) {
        ...
        if (ConnectionUtil(this).isOnline) {
            ...
            val messageModel = MessageModel(getString(R.string.toast_str_35), getString(R.string.toast_message_5),MessageType.NEGATIVE, true)
            CommonUtils.showToast(this, messageModel,"EmailOTPVarifyActivity","makeReSendOtpCall")
        }
