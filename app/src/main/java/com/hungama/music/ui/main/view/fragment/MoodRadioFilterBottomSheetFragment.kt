...
class MoodRadioFilterBottomSheetFragment() : SuperBottomSheetFragment(),
    ...
    private fun setUpMoodRadioPopupMoodViewModel() {
        if (ConnectionUtil(requireContext()).isOnline) {
            ...
            CommonUtils.showToast(requireContext(), messageModel,"MoodRadioFilterBottomSheetFragment","setUpMoodRadioPopupMoodViewModel")
        }
    }
    ...
    private fun setUpMoodRadioPopupTempoViewModel() {
        if (ConnectionUtil(requireContext()).isOnline) {
            ...
            val messageModel = MessageModel(getString(R.string.toast_str_35), getString(R.string.toast_message_5),
                MessageType.NEGATIVE, true)
            CommonUtils.showToast(requireContext(), messageModel,"MoodRadioFilterBottomSheetFragment","setUpMoodRadioPopupTempoViewModel")
        }
    }
    ...
    private fun setUpMoodRadioPopupLanguageViewModel() {
        ...
        if (ConnectionUtil(requireContext()).isOnline) {
            ...
            val messageModel = MessageModel(getString(R.string.toast_str_35), getString(R.string.toast_message_5),
                MessageType.NEGATIVE, true)
            CommonUtils.showToast(requireContext(), messageModel,"MoodRadioFilterBottomSheetFragment","setUpMoodRadioPopupLanguageViewModel")
        }
    ...
    private fun setUpMoodRadioContentList() {
        ...
        if (ConnectionUtil(requireContext()).isOnline) {
            ...
            val messageModel = MessageModel(getString(R.string.toast_str_35), getString(R.string.toast_message_5),
                MessageType.NEGATIVE, true)
            CommonUtils.showToast(requireContext(), messageModel,"MoodRadioFilterBottomSheetFragment","setUpMoodRadioContentList")
        }
    }
    ...
    fun getPlayableContentUrl(id:String){
        if (ConnectionUtil(context).isOnline) {
            ...
            val messageModel = MessageModel(getString(R.string.toast_str_35), getString(R.string.toast_message_5),
                MessageType.NEGATIVE, true)
            CommonUtils.showToast(requireContext(), messageModel,"MoodRadioFilterBottomSheetFragment","getPlayableContentUrl")
        }
    }
