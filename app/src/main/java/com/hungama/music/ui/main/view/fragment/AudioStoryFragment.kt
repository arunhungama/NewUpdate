...
class AudioStoryFragment : BaseFragment(), CreatePlaylistDialog.createPlayListListener,
    BaseActivity.OnLocalBroadcastEventCallBack {

    companion object{
        val FOLLOW_MORE_PODCAST_ID=6007
        val DOWNLOADING_PROGRESS=6008
        val DOWNLOADED_AUDIO_STORY=6009
    }
    ...
    override fun initializeComponent(view: View) {
        baseMainScope.launch {
            ...
            btnExplore.setOnClickListener {
                ...
                bundle.putString(Constant.tabName, "Audio Story")
            ...
            tvnoContentTitle.text = getString(R.string.audio_stories_str_library_heading1)
            tvNoContentBody.text = getString(R.string.audio_stories_str_library_subheading)
...
/*            musicplayList.add(LibraryMusicModel(""+ FOLLOW_MORE_PODCAST_ID,
            ...
            val downloadingPodcastTotal = AppDatabase?.getInstance()?.downloadQueue()?.getDownloadQueueItemsByContentType(
                ContentTypes.AUDIO_STORY.value)
            ...
            val downloadedPodcastTotal = AppDatabase?.getInstance()?.downloadedAudio()?.getDownloadQueueItemsByContentType(ContentTypes.AUDIO_STORY.value)
            ...
            musicLibarayAdapter = LibraryMusicAdapter(requireContext(), musicplayList,object :
                ...
                override fun libraryItemOnClick(musicData: LibraryMusicModel) {
                    if(musicData.id.equals(""+ FOLLOW_MORE_PODCAST_ID)){
                        ...
                        addFragment(R.id.fl_container, this@AudioStoryFragment, followMorePodcastFragment, false)
                        ...
                        addFragment(R.id.fl_container, this@AudioStoryFragment, audioBookDetailsFragment, false)
                    }
                }
            }, true)
...
//        rvMusicLibrary?.isNestedScrollingEnabled=false
    ...
    override fun playListCreatedSuccessfull(id: String) {
        ...
        addFragment(R.id.fl_container, this@AudioStoryFragment, playlistDetailFragment, false)
    }
        ...
        baseMainScope.launch {
            if (ConnectionUtil(requireContext()).isOnline) {
                userViewModel?.getFollwingWithFilter(
                    ...
                    "109"
                )?.observe(this@AudioStoryFragment,
                    Observer {
                        when(it.status){
                            Status.SUCCESS->{
    ...
    private fun setUpLists(userPlaylistData: BookmarkDataModel?) {
        ...
        if (!userPodcastList.isNullOrEmpty()){
            rvPodcastList.apply {
                ...
                adapter = LibraryPodcastsAdapter(context, userPodcastList, object : LibraryPodcastsAdapter.OnChildItemClick {
