...
import kotlinx.android.synthetic.main.activity_enter_mobile.btnSendOTP
import kotlinx.android.synthetic.main.activity_enter_mobile.coordinator
import kotlinx.android.synthetic.main.activity_enter_mobile.etCountryCode
import kotlinx.android.synthetic.main.activity_enter_mobile.etMobileNumber
import kotlinx.android.synthetic.main.activity_enter_mobile.imageFlag
import kotlinx.android.synthetic.main.activity_enter_mobile.tv_send_otp
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        receiver = object : BroadcastReceiver() {
            override fun onReceive(context: Context?, intent: Intent?) {
                CommonUtils.showActivity(this@EnterMobileNumberActivity, EnterMobileNumberActivity::class.java)
            }
        }
        val lbm = LocalBroadcastManager.getInstance(this)
        lbm.registerReceiver(receiver as BroadcastReceiver, IntentFilter(Constant.ENTER_MOBILE))


        if (Constant.DEFAULT_COUNTRY_CODE != "IN")
            txtTitle.text = this.getString(R.string.login_str_63_1)
        ...
        callbacks = object : PhoneAuthProvider.OnVerificationStateChangedCallbacks() {
            ...
            override fun onVerificationCompleted(credential: PhoneAuthCredential) {
                ...
                CommonUtils.showToast(this@EnterMobileNumberActivity, messageModel,"EnterMobileNumberActivity","onVerificationCompleted")
            }
            ...
            override fun onVerificationFailed(e: FirebaseException) {
                ...
                try {
                    if (e is FirebaseAuthInvalidCredentialsException) {
                        ...
                        CommonUtils.showToast(this@EnterMobileNumberActivity, messageModel,"EnterMobileNumberActivity","onVerificationFailed")
        ...
        btnSendOTP.setOnClickListener {
            ...
            if (number.isNotEmpty()) {
                ...
                else if((!selectedCountryCode.equals("+91", true) && number.length < 5)){
                    val messageModel = MessageModel(getString(R.string.toast_str_2),MessageType.NEGATIVE, true)
                    CommonUtils.showToast(this, messageModel,"EnterMobileNumberActivity","onCodeSent")
                }else{
...
//                                setCountryAndHE()
    ...
    private fun loadHEdata(data: HERespModel.Data?) {
        ...
        if(!data?.msisdn.isNullOrEmpty() &&!data?.msisdn?.equals("999999999",true)!!){
