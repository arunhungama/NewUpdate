    ...
    private fun setUpViewModel() {
        try {
            ...
            if (ConnectionUtil(activity).isOnline) {
                ...
                CommonUtils.showToast(requireContext(), messageModel,"MusicChildFragment","setUpViewModel")
            }
        }catch (e:Exception){
    ...
    fun getPlayableContentUrl(id:String){
        try {
            if (context != null && ConnectionUtil(context).isOnline) {
                ...
                val messageModel = MessageModel(getString(R.string.toast_str_35), getString(R.string.toast_message_5),
                    MessageType.NEGATIVE, true)
                CommonUtils.showToast(requireContext(), messageModel,"MusicChildFragment","getPlayableContentUrl")
            }
        }catch (e:Exception){
    ...
    private fun getPlayableMoodRadioList(id:String, type:Int){
        if (isAdded && context != null) {
            if (ConnectionUtil(context).isOnline) {
                ...
                val messageModel = MessageModel(getString(R.string.toast_str_35), getString(R.string.toast_message_5),
                    MessageType.NEGATIVE, true)
                CommonUtils.showToast(requireContext(), messageModel,"MusicChildFragment","getPlayableMoodRadioList")
            }
        }
    }
