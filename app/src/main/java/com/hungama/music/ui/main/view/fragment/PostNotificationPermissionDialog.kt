...
class PostNotificationPermissionDialog(batteryPermission1: BatteryPermission) : SuperBottomSheetFragment(){
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.post_notification_permission_dialog,container,false)
    }
...
//    override fun getStatusBarColor() = Color.RED
    ...
    override fun getExpandedHeight(): Int = requireContext().resources.getDimension(R.dimen.dimen_260).toInt()
