...
import com.hungama.music.data.model.RetryApiInterface
...
class NoInternetDialog(val mContext: Context) : BottomSheetDialogFragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        btnRetry.setOnClickListener {
            ...
            setLog("agfagaf", "${MainActivity.lastBottomItemPosClicked}")
            when(MainActivity.lastBottomItemPosClicked){
                0->DiscoverMainTabFragment.retryApi.value = ""
                1->MusicMainFragment.retryApi.value = ""
                2->VideoMainTabFragment.retryApi.value = ""
                3->LibraryMainTabFragment.retryApi.value = ""
            }
            dismiss()
        }
