...
import com.hungama.music.ui.main.view.activity.EnterMobileNumberActivity.Companion
...
//    private val emailPattern = "[a-zA-Z0-9._-]+@[a-z]+\\.+[a-z]+"
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        receiver = object : BroadcastReceiver() {
            override fun onReceive(context: Context?, intent: Intent?) {
                CommonUtils.showActivity(this@EnterEmailActivity, EnterEmailActivity::class.java)
            }
        }
        val lbm = LocalBroadcastManager.getInstance(this)
        lbm.registerReceiver(receiver as BroadcastReceiver, IntentFilter(Constant.ENTER_EMAIL))
        ...
        btnSendOTP.setOnClickListener {
            ...
            if (email.isNotEmpty()) {
                ...
                if (email.matches(emailPattern.toRegex()) ) {
                    ...
                    CommonUtils.showToast(this, messageModel,"EnterEmailActivity","onCreate")
                }
            } else {
                val messageModel = MessageModel( getString(R.string.toast_str_1),MessageType.NEGATIVE, true)
                CommonUtils.showToast(this, messageModel,"EnterEmailActivity","onCreate")
    ...
    private fun makeSendOtpCall(email: String) {
        ...
        if (ConnectionUtil(this).isOnline) {
            ...
            CommonUtils.showToast(this, messageModel,"EnterEmailActivity","makeSendOtpCall")
        }
        setProgressBarVisible(true)
    }
