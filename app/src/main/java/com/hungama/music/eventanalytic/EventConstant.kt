...
class EventConstant {
    companion object {
        ...
        const val APPLAUNCH_ENAME = "App Open"
...
//  --------------- Favourited --------------------
        ...
        const val SDPCallback = "SDP Callback"
        const val npay_commshandover = "npay_commshandover"
        const val npay_gift = "npay_gift"
        const val npay_displaysuccess = "npay_displaysuccess"
        ...
        const val ModePayment = "Mode of payment"
        const val PlanValue = "Plan Value"
        const val PaymentValue = "Payment Value"
        const val TicketPrice = "Ticket Price"
        const val Currency = "Currency"
        const val BundleSource = "Bundle Source"
        ...
        const val UserRedirect = "user_redirect"
        ...
        const val SUBSCRIPTION_STATUS_EPROPERTY = "subscription_status"
        ...
        const val SUBSCRIPTION_START_DATE_TIME = "subscription_start_date_time"
        const val SUBSCRIPTION_END_DATE_TIME = "subscription_end_date_time"
        ...
        const val MOBILE_NUMBER = "Mobile No"
        ...
        const val BALANCE_MINUTES = "balance_minutes"
        ...
        const val EVENT_DRAWER_VIEW = "event_drawer_view"
        const val EVENT_DRAWER_CLICK = "event_drawer_click"
        const val EVENT_DRAWER_DISMISS = "event_drawer_dismiss"
        /*new events*/
        ...
        const val primary_cta_option_selected = "primary_cta_option_selected"
        ...
        const val AUTO_APP_LANGUAGE = "auto_app_language"
        const val LOGIN_AUTO_SKIP = "login_auto_skip"
        const val AUTO_SELECTED = "auto_selected"
        const val ALANG = "alang"
        const val PostNotification = "Post_notification"
        const val session = "session"
        const val till_session = "till session"

        const val streamed_by_paid_user = "streamed_by_paid_user"
